  ...
  return (
    <main className="space-y-8">
      ...
      <section className="grid md:grid-cols-3 grid-cols-1 gap-6 pb-8 card-counter-wrap ">
        <CardCounter item={total} text="Total Pengingat" bg="bg-blue-300"/>
        <CardCounter item={numberOfItemsInCurrentMonth} text="Pengingat dalam bulan ini" bg="bg-yellow-100"/>
        <CardCounter item={numberOfItemsInFollowingWeek} text="Pengingat pada pekan depan" bg="bg-pink-200"/>
      </section>
